...
/**
 * Example using Poe.com API with proxy configuration.
 * This example demonstrates how to configure a proxy for Poe API requests.
 * 
  ...
  try {
    const result = await zerox({
      credentials: {
        ...
        // Configure proxy for Poe API requests
        // Supports HTTP and HTTPS proxies
        proxy: process.env.PROXY_URL || "http://proxy.example.com:8080",
      },
