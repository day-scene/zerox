...
/**
 * Example using Google Gemini with proxy configuration.
 * This example demonstrates how to configure a proxy for Gemini API requests.
 */
async function main() {
  ...
  try {
    const result = await zerox({
      credentials: {
        ...
        // Optional: Configure proxy for Gemini API requests
